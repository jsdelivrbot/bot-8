...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://github.com/reidon/bot/edit/master/lang/en.json", function (json) {
    ...
    var basicBot  = {
        ...
        chatUtilities: {
            ...
            spam: [
                ...
                'gringo', 'fuder', 'foder', 'hua', 'ahue', 'modafuka', 'modafoka', 'mudafuka', 'mudafoka', 'ooooooooooooooo', 'foda', 'donega'
            ],
            curses: [
        ...
        commands: {
            ...
            cookieCommand: {
              ...
              cookies: ['has given you a grapefruit cookie made fresh from the membrane',
                    ...
                    'gives you a fortune cookie. It reads "m8 pls"',
                    ...
                    'has baked you a fresh batch of heart shaped cookies complete with frosting AND sprinkles. You don’t have to share.',
                    'gives you an animal cracker. It’s a lion! Rawr!',
                    'gives you a crumpet. Would you like some tea?',
                    'gives you a deep fried cookie.',
                    'gives you a gingerbread man…with no limbs.',
                    'gives you 3 boxes of girl scout cookies. Jackpot!',
                    'gives you 4 Oreos and a glass of milk.',
                    'breaks their cookie in half and gives you a piece. It’s definitely the smaller half.',
                    'gives you a peanut butter cookie. I hope you aren’t allergic…',
                    ...
                    'gives you a spooky cookie. It reads “ 2spooby4me” :ghost:',
                    'gives you a…. oops, Cookie Monster came by and snatched yo cookieeee! Watch out!',
                    'gives you a cookie that was run over by a Honda. “VROOOOM SPLAT”',
                    'gives you a cookie fresh from Reidon’s kitchen. It reads “Better be on his good side.”',
